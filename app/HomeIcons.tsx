...
export default function HomeIcons() {
    return (
        <div>
            <Link href="analyze/index.php" className={`${styles.toolBtn} ${styles.analyzeBtn}`}>
                <div>作品分析器</div>
            </Link>
            <Link href="nav/index.php" className={`${styles.toolBtn} ${styles.navBtn}`} >
                <div>航站楼</div>
            </Link>
            {/* <!-- <a href="stat/index.php" class="toolBtn" id="statBtn">
        <div>数据看板(内测)</div>
      </a> --> */}
            <Link href="cmpr/index.php" className={`${styles.toolBtn} ${styles.cmprBtn}`}>
                <div><del>抄袭对比器（开发中）</del></div>
            </Link>
            <Link href="update-log/index.php" className={`${styles.updateLogBtn} ${styles.toolBtn}`}>
                <div>更新日志</div>
            </Link>
